...
<body>
    <div class="tt">
        ...
        <ul id="menu">
            <li><a href="female.php">Female Reservation Analysis</a></li>
        ...
        <div>
            ...
            try {
                ...
                $stmt = $conn->query("SELECT * FROM josaa.final_data");
                $opening_ranks = array();
                $closing_ranks = array();
                $years = array();
                $institutes = array();
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    if ($department != "ALL") {
                        if ($row['Academic_Program_Name'] != $department) $check = false;
                    }
                    if ($seat != "ALL") {
                        if ($row['Seat_Type'] != $seat) $check = false;
                    }
                    if ($gender != "ALL") {
